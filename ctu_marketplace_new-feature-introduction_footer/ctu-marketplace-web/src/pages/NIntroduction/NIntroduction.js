...
import './NIntroduction.scss'

export default function NIntroduction() {
  return (<>
    <div className='none'></div>
    <div className='introduction-view'>
        <div className='introduction-view__header'>
           
            <div className='introduction-view__header__title'>
                Gioi thieu
            </div>
            <div className='introduction-view__header__hightlinghter'>
                <div>Vai tro</div>
                <div>Nhiem vu</div>
                <div>Muc tieu</div>
            </div>
