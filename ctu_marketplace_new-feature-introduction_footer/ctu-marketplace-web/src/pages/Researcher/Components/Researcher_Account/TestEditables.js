    ...
    render() {
        ...
        return(
            <EditablesContext.Provider value={ {...this.state} }>
                <button 
                        className={`btn my-4 ${this.state.showEditingControls ? 'active' : 'inactive'}`} 
                        onClick={this.toggleEditingControls}
                >
                        {`${this.state.showEditingControls ? 'Stop Editing' : 'Start Editing'}`}
                </button>
                <div className="grid-container">
                    
                    <div className="grid-item header">
                        <EditableBackgroundImage 
                            content={pageContent.backgroundImg} 
                            onSave={this.handleContentChange("backgroundImg")} 
                            styles={{ height: "300px"}} uploadImage={uploadImage}
                        >
                            <div className="header-content">
                                <h1>
                                    <EditableText 
                                        content={pageContent.title} 
                                        onSave={this.handleContentChange("title")} 
                                    />
                                </h1>
                            </div>
                        </EditableBackgroundImage>
                        ...
                        <div className="flex-item desc">
                            ...
                            <div className="demo-items">
                                <EditableParagraph 
                                    ...
                                    onSave={this.handleContentChange("paragraph")}
                                />
                            </div>
                            ...
                            <div className="demo-items">
                                <ul>
                                    <li>
                                        <EditableLink 
                                            content={pageContent.link} 
                                            onSave={this.handleContentChange("link")} 
                                        />
                                    </li>
                            ...
                            <div className="demo-items">
                                <EditableTextArea 
                                    content={pageContent.textarea} 
                                    onSave={this.handleContentChange("textarea")} 
                                    EditorProps={{ rows: 4 }} 
                                />
                            </div>
                        ...
                        <div className="flex-item">
                            ...
                            <div className='youtube-video'>
                                <EditableLightboxImageUpload 
                                    content={pageContent.lightboxImage} 
                                    onSave={this.handleContentChange("lightboxImage")} uploadImage={uploadImage} 
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex-item">
                            ...
                            <div className='youtube-video'>
                                <EditableEmbeddedIframe 
                                    content={pageContent.youtubeVideo} 
                                    onSave={this.handleContentChange("youtubeVideo")} 
                                />
                            </div>
                        </div>
                    </div>
